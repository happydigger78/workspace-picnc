...
cprequire_test(["inline:picnc-workspace"], function(ws) {
...
cpdefine("inline:picnc-workspace", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "picnc-workspace", // Make the id the same as the cpdefine id
        name: "Workspace / PiCNC", // The descriptive name of your widget.
        desc: `My PiCNC Workspace.`,
        ...
        /**
         * Load the SVG2Gcode widget via chilipeppr.load()
         */
        loadSVG2GcodeWidget: function(callback) {
            ...
            chilipeppr.load(
              "#com-chilipeppr-widget-svg2gcode-instance",

...
| -------------         | ------------- | 
| ID                    | picnc-workspace |
| Name                  | Workspace / PiCNC |
| Description           | My PiCNC Workspace. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/happydigger78/workspace-picnc/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/happydigger781/picnc |
| Github URL            | http://github.com/happydigger78/workspace-picnc |
| Test URL              | https://preview.c9users.io/happydigger781/picnc/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/happydigger78/workspace-picnc/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:picnc-workspace"], // the id you gave your workspace
      function(myPicncWorkspace) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / PiCNC just got loaded.", myPicncWorkspace);
        myPicncWorkspace.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"picnc-workspace"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / PiCNC"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"My PiCNC Workspace."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/happydigger78/workspace-picnc/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/happydigger781/picnc"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/happydigger78/workspace-picnc"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://picnc-happydigger781.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
...
widget they can fork as a starting point for their own.</td></tr><tr valign="top"><td>loadSpjsWidget</td><td>function</td><td>function (callback) <br><br>Load the Serial Port JSON Server widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadXYZWidget</td><td>function</td><td>function (callback) <br><br>Load the Axes widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadJsCutWidget</td><td>function</td><td>function (callback) <br><br>Load the Axes widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadGcodeListWidget</td><td>function</td><td>function (callback) <br><br>Load the GcodeList widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadSVG2GcodeWidget</td><td>function</td><td>function (callback) <br><br>Load the SVG2Gcode widget via chilipeppr.load()</td></tr><tr valign="top"><td>load3DViewerWidget</td><td>function</td><td>function (callback) <br><br>Load the 3DViewer widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadConsoleWidget</td><td>function</td><td>function (callback) <br><br>Load the Console widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadWorkspaceMenu</td><td>function</td><td>function (callback) <br><br>Load the workspace menu and show the pubsubviewer and fork links using
